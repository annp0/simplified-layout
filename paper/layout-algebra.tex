...
with a padded storage map, \evalPairsStrided{} are layouts of some refinement,
and their emitted forms contain \evalPairsOpsEmitted{} divisions and moduli
where the composites contain \evalPairsOpsPipeline{}. With a random swizzle on
the storage map, none of \evalSwizzled{} is a layout.
