...
argument is needed. The mechanized scan and the implementation are checked
against each other over every $g$ of the enumeration above: they accept the
same maps and return the same chain. Not mechanized: the minimality of the
